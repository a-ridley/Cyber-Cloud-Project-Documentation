...
At the top left next to the CCP icon, you'll see a list of your domains and projects, you can switch freely between them. Currently you are a member of the <project> project.
